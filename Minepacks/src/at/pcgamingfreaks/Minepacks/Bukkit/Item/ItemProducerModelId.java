...
public final class ItemProducerModelId implements IItemProducer
{
	public static final ItemProducerModelId INSTANCE = new ItemProducerModelId();

	private ItemProducerModelId()
	{}

	@Override
	public @NotNull ItemStack make(@NotNull ItemConfig config, int amount)
	{
		ItemStack stack = new ItemStack(config.getMaterial(), amount);
