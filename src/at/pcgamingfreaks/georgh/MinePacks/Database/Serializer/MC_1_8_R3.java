...
public class MC_1_8_R3 extends Base
{
		...
		try
		{
			if (data != null)
		    {
		        ...
		        for (int k = 0; k < i; k++)
		        {
		            ...
		            {
		            	its[k] = CraftItemStack.asBukkitCopy(net.minecraft.server.v1_8_R3.ItemStack.createStack(localNBTTagCompound.getCompound(String.valueOf(k))));
		            }
		        }
		        return its;
		    }
